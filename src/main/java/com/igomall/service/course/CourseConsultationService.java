 ...
 * @version 1.0
 */
public interface CourseConsultationService extends BaseService<CourseConsultation, Long> {
	 ...
	 * @return 咨询，不包含咨询回复
	 */
	List<CourseConsultation> findList(Long memberId, Long courseId, Boolean isShow, Integer count, List<Filter> filters, List<Order> orders, boolean useCache);
	 ...
	 * @param consultation
	 *            咨询
	 * @param replyCourseConsultation
	 *            回复咨询
	 */
	void reply(CourseConsultation consultation, CourseConsultation replyCourseConsultation);
